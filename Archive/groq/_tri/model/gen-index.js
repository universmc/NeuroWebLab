...
async function main() {
    groq.chat.completions.create({
        ...
        messages: [
            ...
            {
                role: "system",
                content: "Génère-moi le code source d'une page d'index qui prend en charge des paramètres racine (/) package.json (pour nodejs) src/css/style.css srv/srv.js (pour groq) dans le norme du web sementique W3c"
            },
            // Définir un message de l'assistant pour introduire la documentation ou la réponse.
            {
                role: "assistant",
                content: "génération des fichier et des script en mode automatique bootstrap Makefile :"
            },
        ...
        const outputFilePath = "output/index_" + new Date().toISOString().replace(/[-:TZ]/g, "") + ".html";
        ...
        console.log("génération du fichier HTML enregistrée dans " + outputFilePath);
    });
}
